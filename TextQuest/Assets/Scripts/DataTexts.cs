...
public static class DataTexts
{
    ...
    public static PartGame FirstPart = new PartGame(1,
        new FrameNarrative[5] {
            ...
            new FrameNarrative(Characters[1], CharacterState.Smile, "СЛЕДУЮЩИЙ ТЕКСТ")
        },
        new FrameQuestion[1] {
            new FrameQuestion(Characters[0], CharacterState.Smile, "А? Да я засмотрелся на этот одуванчик... он напоминает мне..." ,
                new Question[3]
                {
                    new Question( "Лужайку у дома, в котором мы жили летом у бабушки.", Characters[1].Name, 2 ),
                    new Question( "Как всё в этом мире быстротечно", Characters[1].Name, 1),
